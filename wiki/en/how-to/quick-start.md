...
| `pnpm verify:protocol-freeze` | Verify the v0.10 `UVPStateMachine`, v2.1 docking module, the remaining frozen modules, `UVPDeploymentRegistry`, and EIP-712 fixtures. |
