...
The Store is the centralized product and platform workflow workbench. It is responsible for organizing the Nucleus, Zhixu, Supplier, Orders, proofs, and endorsement requests into a human-readable interface. It gives the Nucleus a stage, tags objects with platform metadata, displays proof, initiates governance requests, and keeps audit records; the Nucleus, trust registries, and chain events each keep their own authority source.

## Where Its Authority Comes From

Store’s authority is organizational authority and platform workflow authority. It can say:

- this Zhixu was submitted by a certain Nucleus and passed Store workflow review;
