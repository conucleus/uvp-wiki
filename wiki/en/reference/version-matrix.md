...
| StateMachine ABI / EIP-712 | `0.9` | Signed Plan commit/finalize, composite `(planId, orderId)` orders, permissionless relayer. |
...
| Product submit domain | `0.9` | Product signal-submit EIP-712 domain. |
...
| Docking module ABI | `2.0` | Dock v2 open/input/output/terminal boundary. |
