...
trust registry 是愿意为某类判断提供背书的责任主体。它可以审查这个稳定版本对应的材料、证据要求、参与方要求、适用范围和版本指纹。审查通过后，它在链上发出背书事件。

背书事件的含义是：这个 trust registry 承认这个版本符合它的背书口径。它给后续 Store 展示、订单创建和合作方判断提供可验证依据。
...
- Supplier 是能力和 trust 主体。例如负责进口清关的报关服务商，可以作为 customs Supplier 被背书。
