...
| executor-kit | 执行者、企业系统、supervised AI agent 脚本的集成工具：Product API mode 与 chain watcher mode 两条路径。 | [Executor Kit](../apps/executor-kit.md)、[Order App 与 Executor Kit](../apps/order-app-vs-executor-kit.md) |
